...
`Python Programming` · `OOP` · `Data Structures` · `NumPy` · `Pandas`
...
<p align="left">
<img src="https://skillicons.dev/icons?i=mysql,postgres,sqlite,git,github,vscode" />
</p>

`OpenCV` · `Ultralytics YOLO` · `n8n` · `Google Colab`
